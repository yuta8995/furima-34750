class BuyerAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, item_location_id: item_location_id, municipality: municipality, house_number: house_number, building_name: building_name, tel: tel)
  end
